...
const songs = ["Cian_Ducrot_-_Victory_FlexyOkay.com.mp3", "Years & Years - All For You (256  kbps) (shabakngy.com).mp3"];
...
function navigateToNextPage() {
  window.location.href = "music4.html"; // Replace with your target page's URL
}

backwardButton.addEventListener("click", navigateTobreviousPage);

function navigateTobreviousPage() {
  window.location.href = "music3.html"; // Replace with your target page's URL
}
